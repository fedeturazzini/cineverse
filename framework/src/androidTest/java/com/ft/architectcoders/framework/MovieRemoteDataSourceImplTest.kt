...
class MovieRemoteDataSourceImplTest {
    ...
    @Test
    fun fetchPopularMovies_returnsMoviesFromJson() = runTest {
        // Given
    ...
    @Test
    fun fetchPopularMovies_mapsPostersCorrectly() = runTest {
        // Given
        mockWebServerRule.server.enqueueResponse("popular_movies.json")
    ...
    @Test
    fun fetchPopularMovies_returnsErrorOnServerError() = runTest {
        // Given
    ...
    @Test
    fun fetchPopularMovies_requestIncludesRegion() = runTest {
        // Given
        mockWebServerRule.server.enqueueResponse("popular_movies.json")
