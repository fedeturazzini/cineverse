...
class ProfileDaoTest {
    ...
    @Test
    fun saveAndGetProfile_returnsCorrectData() = runTest {
        // Given
    ...
    @Test
    fun getProfile_whenEmpty_returnsNull() = runTest {
        // When
        val result = profileDao.getProfile().first()
    ...
    @Test
    fun saveProfile_replaceExisting_updatesData() = runTest {
        // Given
    ...
    private fun sampleDbProfile() = DbProfile(
        id = 1,
        name = "Test User",
