...
class MovieRepositoryImplTest {
    ...
    @Test
    fun `Popular movies are taken from local data source`() = runTest {
        // Given
    ...
    @Test
    fun `Popular movies are saved to local data source when it is empty`() = runTest {
        // Given
    ...
    @Test
    fun `Toggling favorite update local data source`() = runTest {
        // Given
    ...
    @Test
    fun `Switching favorite marks as favorite an unfavorite movie`() = runTest {
        // Given
    ...
    @Test
    fun `Switching favorite marks as unfavorite a favorite movie`() = runTest {
        // Given
    ...
    @Test
    fun `findMovieById returns local movie when available`() = runTest {
        // Given
        val movieId = 1
    ...
    @Test
    fun `findMovieById fetches from remote and saves when local is empty`() = runTest {
        // Given
        val movieId = 1
    ...
    @Test
    fun `findMovieById returns remote error when local is empty`() = runTest {
        // Given
        val movieId = 1
    ...
    @Test
    fun `findMovieById returns remote loading when local is empty`() = runTest {
        // Given
        val movieId = 1
        whenever(localDataSource.findMovieById(movieId)).thenReturn(flowOf())
    ...
    @Test
    fun `getMovieCredits returns credits from remote data source`() = runTest {
        // Given
        val movieId = 1
    ...
    @Test
    fun `getMovieCredits returns error from remote data source`() = runTest {
        // Given
        val movieId = 1
        val error = sampleHttpError()
    ...
    @Test
    fun `getMovieVideos returns videos from remote data source`() = runTest {
        // Given
        val movieId = 1
    ...
    @Test
    fun `getMovieVideos returns error from remote data source`() = runTest {
        // Given
        val movieId = 1
        val error = sampleHttpError()
    ...
    @Test
    fun `searchMovies returns movies list when remote succeeds`() = runTest {
        // Given
        val query = "test"
    ...
    @Test
    fun `searchMovies returns empty list when remote fails`() = runTest {
        // Given
        val query = "test"
        val error = sampleHttpError()
    ...
    @Test
    fun `searchMovies returns empty list when remote is loading`() = runTest {
        // Given
        val query = "test"
    ...
    @Test
    fun `Popular movies does not fetch from remote when local has data`() = runTest {
        // Given
        val localMovies = sampleMovies(1, 2, 3)
        whenever(localDataSource.movies).thenReturn(flowOf(localMovies))
    ...
    @Test
    fun `Popular movies does not save when remote returns error`() = runTest {
        // Given
        val localMovies = emptyList<Movie>()
        val error = sampleHttpError()
        whenever(localDataSource.movies).thenReturn(flowOf(localMovies))
    ...
    @Test
    fun `Popular movies does not save when remote returns loading`() = runTest {
        // Given
        val localMovies = emptyList<Movie>()
        whenever(localDataSource.movies).thenReturn(flowOf(localMovies))
