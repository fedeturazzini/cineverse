...
class MovieDetailScreenUITest {
    ...
    @Test
    fun whenMovieLoaded_showMovieDetails(): Unit = with(composeTestRule) {
    ...
    @Test
    fun whenMovieIsNull_showEmptyState(): Unit = with(composeTestRule) {
        setContent {
            MovieDetailScreen(
                state = MovieDetailUiState(
                    movie = null,
    ...
    @Test
    fun whenCastNotEmpty_showCastCarousel(): Unit = with(composeTestRule) {
        val movie = sampleMovie(1)
    ...
    @Test
    fun whenCastEmpty_hideCastCarousel(): Unit = with(composeTestRule) {
        val movie = sampleMovie(1)
        setContent {
            MovieDetailScreen(
                state = MovieDetailUiState(
    ...
    @Test
    fun whenVideosNotEmpty_showTrailersSection(): Unit = with(composeTestRule) {
        val movie = sampleMovie(1)
        val videos = listOf(
            sampleMovieVideo("1"),
            sampleMovieVideo("2")
    ...
    @Test
    fun whenVideosEmpty_hideTrailersSection(): Unit = with(composeTestRule) {
        val movie = sampleMovie(1)
        setContent {
            MovieDetailScreen(
                state = MovieDetailUiState(
    ...
    @Test
    fun whenAiReviewSuccess_showAiReviewCard(): Unit = with(composeTestRule) {
        val movie = sampleMovie(1)
    ...
    @Test
    fun whenAiReviewLoading_showLoadingCard(): Unit = with(composeTestRule) {
        val movie = sampleMovie(1)
        setContent {
            MovieDetailScreen(
                state = MovieDetailUiState(
    ...
    @Test
    fun whenAiReviewError_showErrorCard(): Unit = with(composeTestRule) {
        val movie = sampleMovie(1)
        setContent {
            MovieDetailScreen(
                state = MovieDetailUiState(
    ...
    @Test
    fun whenAiReviewNotRequested_hideAiReview(): Unit = with(composeTestRule) {
        val movie = sampleMovie(1)
        setContent {
            MovieDetailScreen(
                state = MovieDetailUiState(
    ...
    @Test
    fun whenBackButtonClicked_callsOnBack(): Unit = with(composeTestRule) {
    ...
    @Test
    fun whenFavoriteButtonClicked_callsOnFavoriteClick(): Unit = with(composeTestRule) {
    ...
    @Test
    fun whenMovieIsFavorite_showFilledFavoriteIcon(): Unit = with(composeTestRule) {
    ...
    @Test
    fun whenMovieIsNotFavorite_showEmptyFavoriteIcon(): Unit = with(composeTestRule) {
